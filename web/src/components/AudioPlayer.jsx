...
<path d="M17.1653 10.8843V13.0602C17.1653 13.9621 16.5617 14.7524 15.6917 14.9897L15.2566 15.1084C14.1202 15.4185 13 14.563 13 13.385C13 12.5795 13.5391 11.8736 14.3162 11.6616L17.1653 10.8843ZM17.1653 10.8843V2" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round"/>
</svg>
);

const KeysIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M7.13 2H10.63M13.38 2H16.88M8.875 14L8.875 21.875M15.125 14V21.875M4.625 22H19.375C20.4796 22 21.375 21.1046 21.375 20V4C21.375 2.89543 20.4796 2 19.375 2H4.625C3.52043 2 2.625 2.89543 2.625 4V20C2.625 21.1046 3.52043 22 4.625 22Z" stroke="white" strokeWidth="1.5"/>
