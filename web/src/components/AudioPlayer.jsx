...
const MuteIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M21.2199 11.6875V2.30329C21.2199 1.64574 20.5962 1.16716 19.9611 1.33737L9.08008 4.25339C8.64292 4.37054 8.33894 4.76671 8.33894 5.2193V8M21.2199 11.6875V15.4598C21.2199 16.3676 20.6085 17.1616 19.7309 17.3935L18.1449 17.8125M21.2199 11.6875L16.5499 12.9452C15.6767 13.1804 15.0699 13.9721 15.0699 14.8764V14.9844M8.33894 15.1563L3.67894 16.3878C2.80131 16.6197 2.18994 17.4136 2.18994 18.3214V19.4798C2.18994 20.792 3.43228 21.7487 4.70094 21.4134L6.84994 20.8455C7.72758 20.6136 8.33894 19.8197 8.33894 18.9119V15.1563ZM8.33894 15.1563V13M3 3.00001L21 21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
);

const UnmuteIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M8.33894 15.1563V18.9119C8.33894 19.8197 7.72758 20.6136 6.84994 20.8455L4.70094 21.4134C3.43228 21.7487 2.18994 20.792 2.18994 19.4798V18.3214C2.18994 17.4136 2.80131 16.6197 3.67894 16.3878L8.33894 15.1563ZM8.33894 15.1563V5.2193C8.33894 4.76671 8.64292 4.37054 9.08008 4.25339L19.9611 1.33737C20.5962 1.16716 21.2199 1.64574 21.2199 2.30329V11.6875M21.2199 11.6875V15.4598C21.2199 16.3676 20.6085 17.1616 19.7309 17.3935L17.5809 17.9616C16.3122 18.2968 15.0699 17.3401 15.0699 16.0279V14.8764C15.0699 13.9721 15.6767 13.1804 16.5499 12.9452L21.2199 11.6875Z" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10"/>
  </svg>
);

const ChordIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M11.5 5H3.8C3.63431 5 3.5 5.13431 3.5 5.3V12.5M11.5 19.5H3.8C3.63431 19.5 3.5 19.3657 3.5 19.2V12.5M10.5 12.5H3.5M15 3.5V13M15 13V16.7C15 16.8657 15.1346 17.0008 15.3001 16.9926C17.7974 16.8689 19.9307 15.2096 20.4023 12.8521C20.7771 10.9777 19.8229 8.98404 18.1189 8.98404C16.7046 8.98404 15 10.5 15 13Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
  </svg>
);

const SheetMusicIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M22 12H17.5M2 12H13.5M2 19H22M2 5H22" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
    <path d="M17.1653 10.8843V13.0602C17.1653 13.9621 16.5617 14.7524 15.6917 14.9897L15.2566 15.1084C14.1202 15.4185 13 14.563 13 13.385C13 12.5795 13.5391 11.8736 14.3162 11.6616L17.1653 10.8843ZM17.1653 10.8843V2" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
  </svg>
);

const KeysIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M7.13 2H10.63M13.38 2H16.88M8.875 14L8.875 21.875M15.125 14V21.875M4.625 22H19.375C20.4796 22 21.375 21.1046 21.375 20V4C21.375 2.89543 20.4796 2 19.375 2H4.625C3.52043 2 2.625 2.89543 2.625 4V20C2.625 21.1046 3.52043 22 4.625 22Z" stroke="currentColor" stroke-width="1.5"/>
    <path d="M7.125 2.50391H10.625V14.0156H7.125V2.50391Z" fill="currentColor"/>
